...
public class MenuPrincipalModel {
	...
	public MenuPrincipalModel(GTricService gTricService){
		...
		gTricService.getSymbolType().forEach(t->this.symbolType.add(t));
		...
		gTricService.getDataTypes().forEach(t->this.dataType.add(t));
		this.dataTypeEscolhido.setValue(this.dataType.get(0));
		
		gTricService.getDatasetBackground().forEach(b->this.backgroundType.add(b));
		...
		gTricService.getDistributions().forEach(d->this.rowDistribution.add(d));
		this.rowDistEscolhida.setValue(this.rowDistribution.get(0));
		
		gTricService.getDistributions().forEach(d->this.columnDistribution.add(d));
		this.columnDistEscolhida.setValue(this.columnDistribution.get(0));
		
		gTricService.getDistributions().forEach(d->this.contextDistribution.add(d));
		this.contextDistEscolhida.setValue(this.contextDistribution.get(0));
		
		gTricService.getContiguity().forEach(c->this.contiguity.add(c));
		...
		gTricService.getPlaidCoherency().forEach(s->this.plaidCoherency.add(s));
